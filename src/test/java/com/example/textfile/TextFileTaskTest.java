...
import com.example.utilities.TextFailUtilities;
...
public class TextFileTaskTest {
    ...
    private TextFailUtilities textFailUtilities;
    private String textOutFile;

    @BeforeTest()
    public void setUp() {
        textFileTask = new TextFileTask();
        textFailUtilities = new TextFailUtilities();
    }
    ...
    public void testReaderTextFileAndWriterInfoInFile() throws IOException {
        ...
        Assert.assertEquals(textFailUtilities.convertTextFileToStr("outTextFile.txt"), textOutFile);
    }
