...
public class ArrayTaskTest {
    ...
    public void testReverseArray() {
        Assert.assertEquals(new int[]{0, 7, 3, -3, -35, -1}, ArrayTask.reverseArray(NEGATIVE_POSITIVE));
    }
    ...
    public void testReverseArrayEmpty() {
        Assert.assertEquals(EMPTY_ARRAY, ArrayTask.reverseArray(EMPTY_ARRAY));
    }

    @Test(description = "Тестируем не заполненный массив", groups = {"reverseArray"})
    public void testReverseArrayNotValue() {
        Assert.assertEquals(NOT_VALUE_ARRAY, ArrayTask.reverseArray(NOT_VALUE_ARRAY));
    }
    ...
    public void testAddRandomValueEmpty() {
        Assert.assertEquals(EMPTY_ARRAY, ArrayTask.addRandomValue(EMPTY_ARRAY));
    }
    ...
    public void testCompareAverageArraysFirstMore() {
        Assert.assertEquals(1, ArrayTask.compareAverageArrays(POSITIVE_ARRAY, NEGATIVE_ARRAY));
    }
    ...
    public void testCompareAverageArraysSecondMore() {
        Assert.assertEquals(2, ArrayTask.compareAverageArrays(NEGATIVE_ARRAY, POSITIVE_ARRAY));
    }

    @Test(description = "Тестируем среднеарифметическое одинаковые массивы",
            groups = {"compareAverageArrays"})
    public void testCompareAverageArraysEqual() {
        Assert.assertEquals(0, ArrayTask.compareAverageArrays(POSITIVE_ARRAY, POSITIVE_ARRAY));
    }

    @Test(description = "Тестируем не инициализированный первый массив",
            groups = {"compareAverageArrays"})
    public void testCompareAverageArraysNull() {
        Assert.assertEquals(-1, ArrayTask.compareAverageArrays(NULL_ARRAY, POSITIVE_ARRAY));
    }

    @Test(description = "Тестируем пустой второй массив",
            groups = {"compareAverageArrays"})
    public void testCompareAverageArraysEmpty() {
        Assert.assertEquals(-1, ArrayTask.compareAverageArrays(NEGATIVE_POSITIVE, EMPTY_ARRAY));
    }
    ...
    public void testSearchMaxMinValueTwoArray() {
        Assert.assertEquals(MAX_MIN, ArrayTask.searchMaxMinValueTwoArray(TWO_DIMENSIONAL));
    }
    ...
    public void testSearchMaxMinValueTwoArrayNotValue() {
        Assert.assertEquals(new int[][]{{0, 0}, {0, 0}}, ArrayTask.searchMaxMinValueTwoArray(new int[2][2]));
    }
    ...
    public void testSearchUniqueValueOne() {
        Assert.assertEquals(Collections.singletonList(0), ArrayTask.searchUniqueValue(REPEATED_VALUES));
    }
    ...
    public void testSearchUniqueValueAllUnique() {
        Assert.assertEquals(Arrays.asList(5, 3, 9, 10), ArrayTask.searchUniqueValue(POSITIVE_ARRAY));
    }

    @Test(description = "Тестируем массив только с уникальными значениями", groups = {"searchUniqueValue"})
    public void testSearchUniqueValueNull() {
        Assert.assertEquals(Collections.emptyList(), ArrayTask.searchUniqueValue(NULL_ARRAY));
    }

    @Test(description = "Тестируем массив только с уникальными значениями", groups = {"searchUniqueValue"})
    public void testSearchUniqueValueEmpty() {
        Assert.assertEquals(Collections.emptyList(), ArrayTask.searchUniqueValue(EMPTY_ARRAY));
    }
    ...
    public void testSearchUniqueValueNotUnique() {
        Assert.assertEquals(Collections.emptyList(), ArrayTask.searchUniqueValue(NOT_UNIQUE));
    }
    ...
    public void testSearchUniqueValue() {
        Assert.assertEquals(Arrays.asList(0, 5, -1), ArrayTask.searchUniqueValue(WITH_UNIQUE));
    }
    ...
    public void testCalcSumBetweenMinMax() {
        Assert.assertEquals(9, ArrayTask.calcSumBetweenMinMax(POSITIVE_ARRAY));
    }
    ...
    public void testCalcSumBetweenMinMaxNull() {
        Assert.assertEquals(0, ArrayTask.calcSumBetweenMinMax(NULL_ARRAY));
    }

    @Test(description = "Тестируем пустой массив", groups = {"calcSumBetweenMinMax"})
    public void testCalcSumBetweenMinMaxEmpty() {
        Assert.assertEquals(0, ArrayTask.calcSumBetweenMinMax(EMPTY_ARRAY));
    }
    ...
    public void testCalcSumBetweenMinMaxOneValue() {
        Assert.assertEquals(0, ArrayTask.calcSumBetweenMinMax(new int[]{2}));
    }
    ...
    public void testCalcSumBetweenMinMaxTwoValue() {
        Assert.assertEquals(0, ArrayTask.calcSumBetweenMinMax(new int[]{2, 5}));
    }
